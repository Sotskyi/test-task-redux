...
import { DenseTable } from "../UI/components/Table";
...
export const Episode = () => {
  ...
  const endpoint = createFilterEndpoints("episode", filterOptions);
